 ...
 */
@WebServlet(name = "SelectMessengServlet",urlPatterns = "/SelectMessengServlet")
public class SelectMessengServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Messeng> list = dao.selectMesseng(messengType);
